...
static void _blit_linux_screen_color(void* screen_buffer, Uint32 format, int w, int h, int pitch)
{
...
static void _blit_linux_screen_1bit(void* screen_buffer, Uint32 format, int w, int h, int pitch)
{
...
static void _blit_linux_screen_4bit(void* screen_buffer, Uint32 format, int w, int h, int pitch)
{
  const SDL_Color on_color = {.r = 0, .g = 0, .b = 0};
